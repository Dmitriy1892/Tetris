package com.coldfier.tetris.view
...
import com.coldfier.tetris.GameActivity
import com.coldfier.tetris.constants.CellConstants
import com.coldfier.tetris.constants.FieldConstants
import com.coldfier.tetris.models.AppModel
import com.coldfier.tetris.models.Block
...
class TetrisView: View {
    ...
    override fun onSizeChanged(widht: Int, height: Int, previousWidht: Int, previousHeight: Int) {
        super.onSizeChanged(widht, height, previousWidht, previousHeight)
        val cellWidth = (widht - 2 * FRAME_OFFSET_BASE) / FieldConstants.COLUMN_COUNT.value
